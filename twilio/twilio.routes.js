...
const routes = ({ authenticationController, authenticationService, destinyService, destinyTrackerService, userService, worldRepository }) => {
	const middleware = new AuthenticationMiddleWare({ authenticationController });
    const twilioRouter = express.Router();
    const twilioController = new TwilioController({ authenticationService, destinyService, destinyTrackerService, userService, worldRepository });
