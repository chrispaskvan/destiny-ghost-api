...
describe('Postmaster delivery test', () => {
    const image =
        'https://www.bungie.net/common/destiny_content/icons/ea293ac821ec38fa246199ad78732f22.png';
    const url = '/register';
    ...
    describe('error handling', () => {
        it('Should handle email sending errors in register', async () => {
            ...
            await expect(postmaster.register(users[0], image, url)).rejects.toThrow(
        ...
        it('Should handle email sending errors in confirm', async () => {
            ...
            await expect(postmaster.confirm(users[0], image, url)).rejects.toThrow(
                'Invalid recipient',
            );
        });
    });
